...
namespace Xamariners.Common
{
	public class Location
	{
		...
		private const Double EarthRadiusKms = 6376.5;
		...
		public static double DistanceBetweenPoints (double Lat1, 
        ...
        */
		...
		public static double DistanceBetweenPoints(string NS1, double Lat1, double Lat1Min, 
